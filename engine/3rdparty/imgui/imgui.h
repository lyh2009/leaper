...
namespace ImGui
{
    ...
    IMGUI_API bool          MyInputText(const char* label, char* buf, char* buf2,size_t buf_size, size_t buf2_size,ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
