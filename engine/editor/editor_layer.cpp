...
EditorLayer::EditorLayer()
    : Leaper::Layer("EditorLayer"), m_camera(1024.0f / 648.0f)
{
}
...
void EditorLayer::OnUpdate()
{
    ...
    if (m_scene_state == SceneState::Edit)
    {
        ...
        Leaper::Renderer2D::BeginScene(
            camera_entity.GetComponent<Leaper::CameraComponent>().camera.GetCamera(),
            camera_entity.GetComponent<Leaper::TransformComponent>().GetTransform());
