...
public:
    ...
    virtual void SetEventCallback(const EventCallbackFunc &event) override { m_data.event_callback = event; }
    ...
    virtual bool IsClose() const override { return glfwWindowShouldClose(m_window); }
