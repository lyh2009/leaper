...
{
    state.create_named_table("lpTime");
    state["lpTime"]["GetDeltaTime"] = &Time::GetDeltaTime;

    state.new_enum<Leaper::Key>("Key", {
        { "Space", Leaper::Key::Space},      
        { "A", Leaper::Key::A},            
        { "B", Leaper::Key::B},            
        { "C", Leaper::Key::C},            
        { "D", Leaper::Key::D},            
        ...
        { "Y", Leaper::Key::Y},            
        { "Z", Leaper::Key::Z},
        { "Right", Leaper::Key::Right},
        { "Left", Leaper::Key::Left},
        { "UP", Leaper::Key::Up},
        { "Down", Leaper::Key::Down}});    
