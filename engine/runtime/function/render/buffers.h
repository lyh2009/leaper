...
namespace Leaper
{
    ...
    public:
        ...
        BufferLayout(const std::initializer_list<BufferElement>& list) : m_buffer_element(list)
        {
            CalculateStride();
        }

        std::vector<BufferElement> GetBufferElement()
        {
            return m_buffer_element;
        }
        std::vector<BufferElement>::iterator begin()
        {
            return m_buffer_element.begin();
        }
        std::vector<BufferElement>::iterator end()
        {
            return m_buffer_element.end();
        }
