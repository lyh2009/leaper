...
public:
    ...
    static void DrawTexture(Leaper::TransformComponent trans, const Leaper::Ref<Leaper::Texture>& texture,
                            glm::vec4 color = glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), int entity_id = -1);
    static void DrawTexture(Leaper::TransformComponent trans, Leaper::Animation2DComponent anim,
                            const Leaper::Ref<Leaper::Texture>& texture,
                            glm::vec4 color = glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), int entity_id = -1);
    static void DrawSprite(Leaper::TransformComponent trans, Leaper::Ref<Leaper::Texture> texture,
                           glm::vec4 color = glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), int entity_id = -1);
    static void DrawSprite(Leaper::TransformComponent trans, Leaper::Animation2DComponent anim,
                           Leaper::Ref<Leaper::Texture> texture, glm::vec4 color = glm::vec4(1.0f, 1.0f, 1.0f, 1.0f),
                           int entity_id = -1);
