...
namespace Leaper
{
    ...
    {
        j.at("box_collider2d_component").at("tag").get_to(t.user_data->name);
...
template <typename T>
void WriteComponent(nlohmann::json &j_entity, Leaper::Entity entity)
{
    if (entity.HasComponent<T>())
    {
        T &component = entity.GetComponent<T>();
        Leaper::to_json(j_entity, component);
    }
}
